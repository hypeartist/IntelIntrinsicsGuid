...
using IntelIntrinsicsGuide.Controls.HtmlRenderer.Core.Handlers;
using IntelIntrinsicsGuide.Controls.HtmlRenderer.Core.Utils;

namespace IntelIntrinsicsGuide.Controls.HtmlRenderer.Adapters
{
    /// <summary>
    ...
    public abstract class RAdapter
    {
        ...
        /// <summary>
        /// Convert image object returned from <see cref="RImage"/> to <see cref="RImage"/>.
        /// </summary>
