...
namespace Fluent {
	...
	public class FilterMenuBuilder {
		...
		/// </summary>
		public static Bitmap ClearFilteringImage = IntelIntrinsicsGuide.Properties.Resources.clear_filter;

		/// <summary>
		/// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
		/// </summary>
		public static Bitmap FilteringImage = IntelIntrinsicsGuide.Properties.Resources.filter_icons3;
